...
const NameText = (props) => {
    return (
        <div>
            <input type='text' className='sm:w-full sm:appearance-none sm:text-xl sm:font-bold sm:text-center sm:inline sm:border-b-[1.5px] sm:outline-none sm:border-black' value={props.txt} readOnly />
        ...
        return (
            <>
                ...
                <div className='sm:w-[75%] md:w-[50%] sm:h-[10.875rem] sm:mt-2 sm:bg-white sm:flex sm:flex-col sm:mx-auto'>
                    ...
                    <div className='sm:flex sm:items-center sm:border-b-2 sm:border-gray-300 cursor-default md:hover:shadow-[0_1px_1px_1px_rgba(0,0,0,0.15)]'>
